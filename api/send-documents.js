...
<div style="max-width:600px;margin:0 auto;background:white;border-radius:12px;overflow:hidden;margin-top:40px;box-shadow:0 4px 24px rgba(0,0,0,0.06)">
  ...
  <div style="background:linear-gradient(135deg,#1d4ed8,#3b82f6);padding:32px 40px;text-align:center">
    ...
    <p style="color:rgba(255,255,255,0.85);font-size:14px;margin:10px 0 0">Renters' Rights Act 2025 — Action Required</p>
  </div>

  <!-- What is this banner -->
  <div style="background:#fef3c7;border-bottom:2px solid #f59e0b;padding:16px 40px">
  ...
  <div style="padding:36px 40px">
    ...
    <!-- What is this -->
    <div style="background:#eff6ff;border-radius:10px;padding:20px 24px;margin:0 0 24px;border-left:4px solid #3b82f6">
      ...
      <p style="margin:0;font-size:14px;color:#1e293b;line-height:1.7">
        Under the <strong>Renters' Rights Act 2025</strong>, every landlord in England is now legally required to provide each tenant with an official Government Information Sheet before or at the start of a tenancy. Your landlord, <strong>${landlordName}</strong>, is fulfilling this legal duty for your property at <strong>${propertyAddress}</strong>.
      </p>
    </div>

    <!-- Why it matters -->
    <div style="background:#f0fdf4;border-radius:10px;padding:20px 24px;margin:0 0 24px;border-left:4px solid #10b981">
      <p style="margin:0 0 10px;font-size:15px;font-weight:700;color:#065f46">🏠 Why do you need to read it?</p>
      <p style="margin:0 0 12px;font-size:14px;color:#1e293b;line-height:1.7">The attached document is the <strong>official GOV.UK information sheet</strong> that sets out your rights as a tenant. Reading it means you'll know:</p>
      <p style="margin:0 0 6px;font-size:14px;color:#1e293b;line-height:1.6">✓ Your rights if your landlord wants to increase the rent</p>
      <p style="margin:0 0 6px;font-size:14px;color:#1e293b;line-height:1.6">✓ What your landlord must do before ending your tenancy</p>
      <p style="margin:0 0 6px;font-size:14px;color:#1e293b;line-height:1.6">✓ Your right to a well-maintained, safe property</p>
      <p style="margin:0;font-size:14px;color:#1e293b;line-height:1.6">✓ How to raise a dispute or complaint if needed</p>
    </div>

    <!-- Action -->
    <div style="background:#f8fafc;border-radius:10px;padding:20px 24px;margin:0 0 24px;border:1px solid #e2e8f0">
      <p style="margin:0 0 10px;font-size:15px;font-weight:700;color:#1e293b">📎 What you need to do</p>
      <p style="margin:0;font-size:14px;color:#475569;line-height:1.7">
        <strong>Open the PDF attached to this email</strong> and read it. That's all. There's nothing to sign or return. Your receipt of this document is recorded automatically and protects both you and your landlord under the new legislation.
      </p>
    </div>

    <p style="font-size:14px;color:#475569;line-height:1.7;margin:0 0 32px">
      If you have questions about your tenancy rights, <a href="https://www.citizensadvice.org.uk" style="color:#3b82f6;text-decoration:none;font-weight:600">Citizens Advice</a> offers free, independent guidance. For questions about the Renters' Rights Act itself, visit <a href="https://www.gov.uk/government/collections/renters-rights-bill" style="color:#3b82f6;text-decoration:none;font-weight:600">GOV.UK</a>.
    </p>

    <hr style="border:none;border-top:1px solid #e2e8f0;margin:0 0 24px;"/>

    <p style="font-size:12px;color:#94a3b8;line-height:1.6;margin:0;">
      This email was sent on behalf of <strong>${landlordName}</strong> by <strong>CompliantUK</strong>, a compliance document delivery service for private landlords in England. CompliantUK is not a letting agent and has no role in managing your tenancy. Delivery of this document is recorded for legal compliance purposes only.
    </p>
  </div>
