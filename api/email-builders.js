...
export function buildTenantEmail({ tenantFirst, tenantLast, landlordFirst, landlordLast, propertyAddress, trackingPixelUrl }) {
  return `<!DOCTYPE html>
...
export function buildLandlordEmail({ landlordFirst, landlordLast, landlordEmail, propertyAddress, tenants, amountFormatted, isNewAccount, tempPassword, orderRef, orderDate, dashboardUrl, loginUrl }) {
