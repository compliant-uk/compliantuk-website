...
test('Webhook normalises tenant name/email before sending', () => webhook.includes('function normaliseTenant') && webhook.includes("if (!t.email) throw new Error('Tenant email missing')") || 'Missing tenant normalisation/guard');
